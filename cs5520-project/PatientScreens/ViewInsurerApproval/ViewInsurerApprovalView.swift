...
class ViewInsurerApprovalView: UIView {
    ...
    private func setupViews() {
        ...
        tableView.register(PGrantApprovalTableViewCell.self, forCellReuseIdentifier: "PApprovalCell")
...
class PGrantApprovalTableViewCell: UITableViewCell {
