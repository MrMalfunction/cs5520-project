...
class InsuranceHSController: UIViewController {
    ...
    // MARK: - Properties
    private var insuranceView: InsuranceHSView!
    ...
    private func setupDelegates() {
        insuranceView.searchBar.delegate = self
        insuranceView.tableView.delegate = self
        insuranceView.tableView.dataSource = self
    }
    ...
    private func fetchPatients() {
        firestoreHelpers.fetchCurrentInsurerPatientsDetails { [weak self] result in
            ...
            DispatchQueue.main.async {
                ...
                case .success(let patients):
                    if patients.isEmpty {
                        ...
                        self.insuranceView.tableView.reloadData()
                    }
...
extension InsuranceHSController: UISearchBarDelegate {
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        insuranceView.tableView.reloadData()
    }
...
extension InsuranceHSController: UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return filteredPatients.count
    }

    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "InsurancePatientCell", for: indexPath) as? InsurancePatientCell else {
...
extension InsuranceHSController: UITableViewDelegate {
