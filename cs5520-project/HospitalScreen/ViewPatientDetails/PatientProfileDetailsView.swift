...
class PatientProfileDetailsView: UIView {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            dobField.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),
            dobField.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -20),
            ...
            genderField.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),
            genderField.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -20),
            
            // Blood Group
            bloodGroupLabel.topAnchor.constraint(equalTo: genderField.bottomAnchor, constant: 10),
            bloodGroupLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),
            bloodGroupField.topAnchor.constraint(equalTo: bloodGroupLabel.bottomAnchor, constant: 5),
            bloodGroupField.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),
            bloodGroupField.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -20),
            ...
            userTypeLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),
            userTypeField.topAnchor.constraint(equalTo: userTypeLabel.bottomAnchor, constant: 5),
            userTypeField.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),
            userTypeField.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -20),
            
            // Linked Hospitals
            linkedHospitalsLabel.topAnchor.constraint(equalTo: userTypeField.bottomAnchor, constant: 10),
            linkedHospitalsLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),
            linkedHospitalsField.topAnchor.constraint(equalTo: linkedHospitalsLabel.bottomAnchor, constant: 5),
            linkedHospitalsField.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),
            linkedHospitalsField.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -20),
            ...
            linkedInsurersLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),
            linkedInsurersField.topAnchor.constraint(equalTo: linkedInsurersLabel.bottomAnchor, constant: 5),
            linkedInsurersField.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),
            linkedInsurersField.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -20),
            linkedInsurersField.heightAnchor.constraint(equalToConstant: 40),
            linkedInsurersField.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -20)
        ])
    }
}
