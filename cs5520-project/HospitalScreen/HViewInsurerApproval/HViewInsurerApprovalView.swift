...
class HViewInsurerApprovalView: UIView {
    ...
    private func setupViews() {
        ...
        tableView.register(HGrantApprovalTableViewCell.self, forCellReuseIdentifier: "HApprovalCell")
...
class HGrantApprovalTableViewCell: UITableViewCell {
